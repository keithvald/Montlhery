			...
			<div class="col-12 col-md-8">
				...
				<div class="row">
					...
					<button class="code-interest" type="button" data-target="#mon-collapse" data-toggle="collapse"
						aria-expanded="false" aria-controls="#mon-collapse">Lire la suite</button>
				</div>
			</div>

			<div class="card-custom-position col-12 col-md-4">
				<div class="card">
					<img src="../assets/img/cards/accelere.webp" alt="icon" class="card-img-top" width="500" height="500" />
