	...
	<div class="landing-page-description">
		<div class="jumbotron row p-8">
			...
			<div class="card-custom-position col-12 col-md-4">
				<div class="card">
					<img src="../assets/img/cards/code.webp" alt="icon" class="card-img-top" />
...
<div class="container-fluid my-5">
	...
	<div class="row p-8">
		<div class="col-12 mb-5 col-md-6 text-center align-self-center">
			<a class="prepa-code-transition" href="https://www.prepacode-enpc.fr/landing_page" target="_blank"
				rel="noopener noreferrer">
				<img src="../assets/img/logos/prepacode-index.png" alt="logo-prepacode" class="prepacode-logo" />
			</a>
		</div>
